...
constant integer FIRST_WAVE_TIME= 1
constant integer SPAWN_FREQUENCY= 2
constant integer WAVE_TIME= 40
constant integer WAVE_INTERVAL= 1
constant integer BOSS_WAVE_INTERVAL= 9
...
function CreateBuildingsForPlayer4 takes nothing returns nothing
    ...
    local trigger t
    local real life
    set u=CreateUnit(p, 'o00Q', - 64.0, 0.0, 270.000)
    set u=CreateUnit(p, 'o00R', 128.0, 0.0, 270.000)
endfunction
//===========================================================================
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_circle=Rect(- 4512.0, - 4896.0, 4480.0, 4192.0)
    set we=AddWeatherEffect(gg_rct_circle, 'RAlr')
    call EnableWeatherEffect(we, true)
    set gg_rct______________001=Rect(- 3904.0, 3712.0, - 3744.0, 3904.0)
    set gg_rct______________002=Rect(- 64.0, 3744.0, 64.0, 3904.0)
    set gg_rct______________003=Rect(3744.0, 3712.0, 3904.0, 3872.0)
    set gg_rct______________004=Rect(3744.0, - 96.0, 3904.0, 96.0)
    set gg_rct______________005=Rect(3744.0, - 3904.0, 3904.0, - 3776.0)
    set gg_rct______________006=Rect(- 96.0, - 3936.0, 64.0, - 3776.0)
    set gg_rct______________007=Rect(- 3936.0, - 3968.0, - 3744.0, - 3808.0)
    set gg_rct______________008=Rect(- 3936.0, - 64.0, - 3776.0, 64.0)
    set gg_rct______________009=Rect(- 2912.0, - 96.0, - 2720.0, 64.0)
    set gg_rct______________010=Rect(- 2912.0, 2784.0, - 2752.0, 2912.0)
    set gg_rct______________011=Rect(- 1888.0, 2784.0, - 1728.0, 2944.0)
    set gg_rct______________012=Rect(- 64.0, 2752.0, 96.0, 2912.0)
    set gg_rct______________013=Rect(2720.0, 2752.0, 2848.0, 2880.0)
    set gg_rct______________014=Rect(2720.0, 1728.0, 2880.0, 1888.0)
    set gg_rct______________015=Rect(2752.0, - 64.0, 2880.0, 96.0)
    set gg_rct______________016=Rect(2688.0, - 2880.0, 2848.0, - 2752.0)
    set gg_rct______________017=Rect(1696.0, - 2880.0, 1856.0, - 2752.0)
    set gg_rct______________018=Rect(- 96.0, - 2912.0, 64.0, - 2752.0)
    set gg_rct______________019=Rect(- 2912.0, - 2880.0, - 2752.0, - 2752.0)
    set gg_rct______________020=Rect(- 2880.0, - 1888.0, - 2720.0, - 1728.0)
    set gg_rct______________021=Rect(- 1024.0, - 1984.0, - 544.0, - 1792.0)
    set gg_rct______________022=Rect(- 2016.0, 544.0, - 1792.0, 1024.0)
    set gg_rct______________023=Rect(544.0, 1760.0, 1024.0, 1984.0)
    set gg_rct______________024=Rect(1792.0, - 1024.0, 2016.0, - 576.0)
    set gg_rct_spawn1=Rect(- 1120.0, 448.0, - 448.0, 1088.0)
    set gg_rct_spawn2=Rect(448.0, 448.0, 1088.0, 1056.0)
    set gg_rct_spawn3=Rect(448.0, - 1088.0, 1088.0, - 480.0)
    set gg_rct_spawn4=Rect(- 1088.0, - 1088.0, - 448.0, - 480.0)
endfunction
//***************************************************************************
//*
//*  Custom Script Code
...
function InitTrig_______u takes nothing returns nothing
    ...
    call TriggerRegisterTimerEventSingle(gg_trg_______u, 0.10)
...
function config takes nothing returns nothing
    ...
    call DefineStartLocation(0, - 2304.0, 1728.0)
    call DefineStartLocation(1, 1792.0, 2240.0)
    call DefineStartLocation(2, 2304.0, - 1600.0)
    call DefineStartLocation(3, - 1536.0, - 2368.0)
    call DefineStartLocation(4, 0.0, 0.0)
    call DefineStartLocation(5, - 512.0, - 4800.0)
    call DefineStartLocation(6, 640.0, - 4800.0)
    // Player setup
