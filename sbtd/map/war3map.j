...
function CreateAllItems takes nothing returns nothing
    ...
    call CreateItem('I01Z', 265.6, 96.9)
    call CreateItem('I01Z', 256.6, - 239.5)
    call CreateItem('I01Z', - 28.5, - 242.0)
    call CreateItem('I01Z', 278.3, - 57.0)
endfunction
//***************************************************************************
//*
//*  Unit Creation
...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    local trigger t
    local real life
    set u=CreateUnit(p, 'Hamg', 50.8, - 15.8, 168.074)
endfunction
//===========================================================================
