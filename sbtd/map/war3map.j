...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_circle=Rect(- 4512.0, - 4512.0, 4512.0, 4512.0)
    set we=AddWeatherEffect(gg_rct_circle, 'RAlr')
    call EnableWeatherEffect(we, true)
    set gg_rct______________001=Rect(- 4096.0, 3584.0, - 3616.0, 4032.0)
    set gg_rct______________002=Rect(- 224.0, 3616.0, 224.0, 4064.0)
    set gg_rct______________003=Rect(3616.0, 3616.0, 4064.0, 4032.0)
    set gg_rct______________004=Rect(3616.0, - 256.0, 4096.0, 224.0)
    set gg_rct______________005=Rect(3616.0, - 4064.0, 4064.0, - 3616.0)
    set gg_rct______________006=Rect(- 256.0, - 4064.0, 224.0, - 3648.0)
    set gg_rct______________007=Rect(- 4064.0, - 4064.0, - 3584.0, - 3616.0)
    set gg_rct______________008=Rect(- 4064.0, - 224.0, - 3616.0, 224.0)
    set gg_rct______________009=Rect(- 3072.0, - 192.0, - 2592.0, 192.0)
    set gg_rct______________010=Rect(- 3040.0, 2592.0, - 2560.0, 3008.0)
    set gg_rct______________011=Rect(- 2048.0, 2592.0, - 1536.0, 3008.0)
    set gg_rct______________012=Rect(- 256.0, 2592.0, 256.0, 3040.0)
    set gg_rct______________013=Rect(2592.0, 2560.0, 3040.0, 3008.0)
    set gg_rct______________014=Rect(2560.0, 1568.0, 3040.0, 1984.0)
    set gg_rct______________015=Rect(2592.0, - 224.0, 3040.0, 192.0)
    set gg_rct______________016=Rect(2560.0, - 3040.0, 3040.0, - 2592.0)
    set gg_rct______________017=Rect(1568.0, - 3040.0, 2048.0, - 2624.0)
    set gg_rct______________018=Rect(- 256.0, - 3040.0, 256.0, - 2592.0)
    set gg_rct______________019=Rect(- 3040.0, - 3040.0, - 2560.0, - 2560.0)
    set gg_rct______________020=Rect(- 3040.0, - 2048.0, - 2560.0, - 1568.0)
    set gg_rct______________021=Rect(- 1024.0, - 1984.0, - 544.0, - 1568.0)
    set gg_rct______________022=Rect(- 2016.0, 544.0, - 1568.0, 1024.0)
    set gg_rct______________023=Rect(544.0, 1536.0, 1024.0, 1984.0)
    set gg_rct______________024=Rect(1568.0, - 1024.0, 2016.0, - 576.0)
endfunction
//***************************************************************************
//*
//*  Custom Script Code
